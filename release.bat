...
::           release.bat minor "Add color themes support" -y
...
:usage
    ...
    echo   release.bat patch "Fix bug" -y    (auto-confirm all prompts)
    echo.
...
echo %C_BOLD%%C_GREEN%╚══════════════════════════════════════════════╝%C_RESET%
echo.
echo   Repository:  https://github.com/yosef-chai/ha-checklist-card
echo   Release:     https://github.com/yosef-chai/ha-checklist-card/releases/tag/!NEW_TAG!
echo.
